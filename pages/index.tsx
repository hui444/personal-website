...
import { BREAKPOINT, SECTIONS } from 'common/constants'
              ...
              <FlexBox ref={aboutSectionRef} className={SECTIONS.ABOUT}>
                <IntroContent>
                  ...
                  <p>
                    ...
                    National University of Singapore, with a strong background
                    in web development and special care on the user experience.
